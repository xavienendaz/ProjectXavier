 ...
 */
    ...
    public class EndpointsAsyncTaskLikeDelete extends AsyncTask<Void, Void, List<com.example.xavier.myapplication.backend.voteApi.model.Vote>> {
        private static VoteApi voteApi = null;
        private static final String TAG = com.example.xavier.projectxavier.EndpointsAsyncTaskLikeDelete.class.getName();
        private com.example.xavier.myapplication.backend.voteApi.model.Vote vote;

    EndpointsAsyncTaskLikeDelete(){}

    EndpointsAsyncTaskLikeDelete(com.example.xavier.myapplication.backend.voteApi.model.Vote vote){
            this.vote = vote;
        }
        ...
        protected List<com.example.xavier.myapplication.backend.voteApi.model.Vote> doInBackground(Void... params) {
            ...
            try{
                ...
                // For instance insert
                if(vote != null){
                    voteApi.remove(vote.getId()).execute();

                    Log.i(TAG, "remove vote");
                }
